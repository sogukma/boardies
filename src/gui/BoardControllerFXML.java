...
public class BoardControllerFXML implements Initializable {
	 ...
	 * Controller (des Startmen�s) entgegen. Die beiden Listener im Konstrukor
	 * �berwachen, die im �BoardModel.java� genannten StringProperty-Observables
	 * �newMessage� und �newCards�. Sobald sich einer der Beiden Observables
	 * �ndert, wird vor hier die entsprechende Funktion f�r die Aktualisierung
	 * der GUI aufgerufen.
	 * 
	 * @param bm
	 *            BoardModel
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		/**
		 *
		 * Alle Nachkommenden MouseEvents sind für Events die spezifisch nur für
	...
	/**
	 * Für die Erstellung der PunktKarten für das Hand, wird diese Methode
	 * verwendet
	 * 
	 * @param id
	 * @param img
